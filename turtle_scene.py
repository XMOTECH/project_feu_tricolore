...
class SceneBuilder:
    ...
    def draw_background(self):
        ...
        turtle.bgcolor("#1b5e20")  # Vert plus professionnel (Deep Forest Green)
    ...
    def _draw_sidewalks_refined(self):
        ...
        LAWN = "#2e7d32"     # Vert parc
        BITUMEN = "#263238"  # Noir trottoir
        CURB = "#455a64"      # Gris bordure
    ...
    def _draw_lane_markings(self):
        ...
        # Doubles Jaunes
        self.pen.pensize(2); self.pen.color("#fdd835")
        for offset in [-2, 2]:
        ...
        # Pointillés Blancs
        self.pen.color("white"); self.pen.pensize(1)
        for y in [-35, 35]:
    ...
    def _draw_stop_lines(self):
        ...
        self.pen.color("white"); self.pen.pensize(6)
    ...
    def _draw_house(self, x, y, color):
        ...
        self.pen.penup(); self.pen.goto(x, y); self.pen.color(color); self.pen.begin_fill()
        ...
        self.pen.color("#eceff1"); self.pen.goto(x + 30, y + 25); self.pen.dot(20)

    def draw_decorations(self):
        """Maisons et Lampadaires."""
        self._draw_house(-500, 300, "#cfd8dc")
        self._draw_house(410, 300, "#f8bbd0")
        self._draw_house(-500, -450, "#dcedc8")
        self._draw_house(410, -450, "#fff9c4")
        lamp_positions = [(-105, 105), (105, 105), (-105, -105), (105, -105)]
        for x, y in lamp_positions: self._draw_street_lamp(x, y)
